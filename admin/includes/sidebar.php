...
<!--- Sub-Categories --->
    ...
    <!--vehicle type-->
    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#vehicle" aria-expanded="false" aria-controls="vehicle">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Vehicle Type
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="vehicle" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-vehicle-type.php">Add</a>
                                    <a class="nav-link" href="manage-vehicletype.php">Manage</a>
                                </nav>
                            </div>
 ...
 <!--Brand-->
    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#brand" aria-expanded="false" aria-controls="brand">
                            ...
                            <div class="collapse" id="brand" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-brand.php">Add</a>
                                    <a class="nav-link" href="manage-brands.php">Manage</a>
                                </nav>
                            </div>

    <!--model series name type-->
    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#modelseries" aria-expanded="false" aria-controls="modelseries">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Model Series Name
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="modelseries" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-modelseries.php">Add</a>
                                    <a class="nav-link" href="manage-modelseries.php">Manage</a>
                                </nav>
                            </div>

 <!--Model name-->
    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#model" aria-expanded="false" aria-controls="model">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Model Name
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="model" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-model.php">Add</a>
                                    <a class="nav-link" href="manage-model.php">Manage</a>
                                </nav>
                            </div>
   ...
   <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#inventory" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="inventory" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="instockproducts.php">In Stock</a>
                                     <a class="nav-link" href="outofstockpr.php">Out Of Stock</a>
                                </nav>
                            </div>
