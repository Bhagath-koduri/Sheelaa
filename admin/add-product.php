...
if(isset($_POST['submit']))
{
    ...
    $modelSeriesName=$_POST['modelSeriesName'];
    ...
    $productDisplay =$_POST['productDisplay'];
...
$sql=mysqli_query($con,"insert into products(vehiceltypeid,brandid,modelseriesid,modelid,productName,skuNum,productPrice,productDescription,shippingCharge,displayType,productAvailability,productImage1,productImage2,productImage3,addedBy) values('$vehicleName','$brandName','$modelSeriesName','$modelName','$productname','$skuNumber','$productprice','$productdescription','$productscharge','$productDisplay','$productavailability','$imgnewfile1','$imgnewfile2','$imgnewfile3','$addedby')");
...
<html lang="en">
    <head>
        ...
        <title>Ozz One| Add Products</title>
...
function getModelSeries(val) {
    $.ajax({
    type: "POST",
    url: "get_modelseries.php",
    data:'brand_id='+val,
    success: function(data){
        $("#modelSeriesName").html(data);
    }
    });
}
...
<div class="col-4">
<select name="vehicleName" id="vehicleName" class="form-control" onChange="getBrand(this.value);" required>
...
<div class="col-4">
<select name="brandName" id="brandName" class="form-control" onChange="getModelSeries(this.value);" required>
</select>    
</div>
</div>
...
<div class="col-4">
<select name="modelSeriesName" id="modelSeriesName" class="form-control" onChange="getModel(this.value);" required>
</select>    
</div>
</div>
...
<div class="col-4">
<select name="modelName" id="modelName" class="form-control" required>
</select>    
</div>
</div>
...
<!-- </div> -->
 ...
 <div class="row" style="margin-top:1%;"> 
<div class="col-2">SKU Number</div>
<div class="col-4"><input type="text"    name="skuNumber" id="skuNumber" placeholder="Enter SKU Number" class="form-control" required>
</select>
</div>
</div>
<!-- <div class="row" style="margin-top:1%;">
...
<!-- <div class="row" style="margin-top:1%;">
<div class="col-2">Product Discount(in %)</div>
<div class="col-4"><input type="text"    name="productdiscount"  placeholder="Enter Product Price" class="form-control" required>
</select>
</div>
</div> -->
...
<div class="col-4">
    <input type="number" name="productAvailability" id="productAvailability" class="form-control" required min='0' max='1000' value="1"/>
...
<div class="row" style="margin-top:1%;">
<div class="col-2">Product Display Under</div>
<div class="col-4"><select   name="productDisplay"  id="productDisplay" class="form-control" required>
<option value="">Select</option>
