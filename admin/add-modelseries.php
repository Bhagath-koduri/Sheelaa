...
$sql=mysqli_query($con,"insert into modalseries(brandid,modelseriesName,createdBy) values('$brandid','$modelseriesName','$createdby')");
echo "<script>alert('Model Series added successfully');</script>";
...
<div class="row" >
<div class="col-2">Select Brand Name</div>
<div class="col-4">
...
<div class="col-4"><input type="text" placeholder="Enter model Series name"  name="modelseriesName" id="modelseriesName" class="form-control" required></div>
</div>
