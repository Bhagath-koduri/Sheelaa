...
$sql=mysqli_query($con,"insert into vehicletype(vehicleName,createdBy) values('$vehicleName','$createdby')");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Add Vehicle Type</h1>
...
<form  method="post">                                
<div class="row">
<div class="col-2">Vehicle Name</div>
<div class="col-4"><input type="text" placeholder="Enter vehicle name"  name="vehicleName" class="form-control" required></div>
</div>
