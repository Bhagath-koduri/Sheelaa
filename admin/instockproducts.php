                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php 
$query=mysqli_query($con,"select products.id as pid,products.productName,products.productAvailability , products.postingDate,products.updationDate,tbladmin.username from products join tbladmin on tbladmin.id=products.addedBy order by pid desc");
$cnt=1;
